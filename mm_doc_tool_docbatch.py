...
class DoclingParser:
    ...
    def _create_pipeline_options(config: ParserConfig) -> PdfPipelineOptions:
        ...
        options.layout_options.keep_empty_clusters = False
        options.layout_options.skip_cell_assignment = False
        options.layout_options.create_orphan_clusters = False
...
if __name__ == "__main__":
    ...
    for filename, md_content in results.items():
